        ...
        success: function (data) {
            if (data.Result == "OK") {
                if (data.Data.IsVariant) {
                    window.location.href = "index-1.htm"/*tpa=http://runecom03.runtime.vn/san-pham/*/ + data.Data.ProductCode + ".html";
                }
                else {
                    window.location.href = "gio-hang.html"/*tpa=http://runecom03.runtime.vn/gio-hang.html*/;
                }
            }
        },
        error: function () {
