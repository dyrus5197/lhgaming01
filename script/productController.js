appMain.controller('productController', function ($scope, $rootScope, $element, $location, $window, productService, alertsService) {
    ...
    $scope.addToCardBuyCompleted = function (response) {
        $window.location.href = "thanh-toan.html"/*tpa=http://runecom03.runtime.vn/thanh-toan.html*/;
    }
    ...
    $scope.callMe = function () {
        ...
        var obj = {
            ...
            Email: "notfound.html-aspxerrorpath=-app-controllers-info@runtime.vn.htm"/*tpa=http://runecom03.runtime.vn/app/controllers/info@runtime.vn*/,
